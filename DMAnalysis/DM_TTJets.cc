...
bool TTJets::PrintEvents(){
  ...
  std::cout << "========================================" << std::endl;
  std::cout << "==============TTbar + JETS==================" << std::endl;
  std::cout << "========================================" << std::endl;
  std::cout << "WEIGHT:: " << weight << std::endl;
  std::cout << "TTJets weighted Nt_In: " << NtotGen*weight << std::endl;
  std::cout << "TTJets weighted Nt_PV: " << Nt_PV*weight << std::endl;
  std::cout << "TTJets weighted Nt_2J: " << Nt_2J*weight << std::endl;
  std::cout << "TTJets weighted Nt_0b: " << Nt_0b*weight << std::endl;
  std::cout << "TTJets weighted Nt_LepVeto: " << Nt_LepVeto*weight << std::endl;

  std::cout << "TTJets  NEntries weighted: " << T->GetEntries()*weight << "\n\n" << std::endl; 
  ...
  std::cout << "TTJets weighted Nt_MR_RSQ_cut: " << Nt_MR_RSQ_cut*weight << std::endl;
  std::cout << "TTJets weighted Nt_0muBox: " << Nt_0muBox*weight << std::endl;
  std::cout << "TTJets weighted Nt_1muBox: " << Nt_1muBox*weight << std::endl;
  std::cout << "TTJets weighted Nt_2muBox: " << Nt_2muBox*weight << std::endl;

  std::cout << "TTJets weighted Nt_MR_RSQ_cut0BTag: " << Nt_MR_RSQ_cut0BTag*weight << std::endl;
  std::cout << "TTJets weighted Nt_0muBox0BTag: " << Nt_0muBox0BTag*weight << std::endl;
  std::cout << "TTJets weighted Nt_1muBox0BTag: " << Nt_1muBox0BTag*weight << std::endl;
  std::cout << "TTJets weighted Nt_2muBox0BTag: " << Nt_2muBox0BTag*weight << std::endl;

  std::cout << "TTJets Btag EVENTS: " << (Nt_MR_RSQ_cut - Nt_MR_RSQ_cut0BTag)*weight << std::endl;
...
bool TTJets::CalcWeight(){
  ...
  std::cout << "TTJets weight: " << weight << std::endl;
  return true;
...
std::vector<TH1F*> TTJets::PlotMETx(){
  ...
  for(int l = 0; l < 3; l++ ){
    for( int m = 0; m < 3; m++ ){
      name = TString(Form("TT_metXBox%d_plotType%d",l,m));
...
std::vector<TH1F*> TTJets::PlotMETy(){
  double met, metcorr, RSQ, MR;
  int BOX, nBtag;
  ...
  for(int l = 0; l < 3; l++ ){
    for( int m = 0; m < 3; m++ ){
      name = TString(Form("TT_metY_Box%d_plotType%d",l,m));
...
std::vector<TH1F*> TTJets::PlotHT(){
  ...
  TString name;
  for(int l = 0; l < 3; l++ ){
    name = TString(Form("TT_HT_Box%d",l));
